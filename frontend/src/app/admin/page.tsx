...
const adminCards = [
  {
    ...
    description: "نمای کلی سوالات، درخواست‌ها، بانک دانش و وضعیت سیستم.",
    Icon: BarChart3,
  ...
  },
  {
    ...
    title: "بانک دانش",
    description: "افزودن کاتالوگ، استاندارد، اپلیکیشن‌نوت و FAQ تاییدشده.",
    Icon: Database,
  ...
  },
  {
    ...
    description: "بررسی، اصلاح، تایید و تبدیل پاسخ‌های خوب به دانش داخلی.",
    Icon: FileQuestion,
  ...
  },
  {
    ...
    description: "پیگیری درخواست‌های مشاوره، تجهیزات، کاتالیست و استعلام قیمت.",
    Icon: Inbox,
  ...
  },
  {
    href: "/admin/settings",
    title: "تنظیمات سیستم",
    description: "بررسی Backend، اتصال OpenAI، fallback محلی و آمار بانک دانش.",
    Icon: Settings2,
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-4 max-w-4xl leading-8 text-slate-600">
                  این بخش برای مدیریت بانک دانش، بررسی سوالات کاربران، تایید
                  پاسخ‌ها، پیگیری درخواست‌های مشتریان و پایش وضعیت سیستم استفاده
                  می‌شود.
                </p>
              </div>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_360px]">
            ...
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-black text-slate-900">
                  روند پیشنهادی مدیریت کیفیت آرتین
                </h2>
            ...
            <div className="grid gap-3 md:grid-cols-4">
              <div className="rounded-3xl bg-slate-50 p-4">
                ...
                <p className="text-sm leading-7 text-slate-600">
                  سوال‌های جدید کاربران را از بخش سوالات کاربران بررسی کنید.
                </p>
              </div>
              ...
              <div className="rounded-3xl bg-slate-50 p-4">
                ...
                <p className="text-sm leading-7 text-slate-600">
                  پاسخ آرتین را در صورت نیاز کامل‌تر و تخصصی‌تر کنید.
                </p>
              </div>
              ...
              <div className="rounded-3xl bg-slate-50 p-4">
                ...
                <p className="text-sm leading-7 text-slate-600">
                  پاسخ تاییدشده را به بانک دانش اضافه کنید.
                </p>
              </div>
              ...
              <div className="rounded-3xl bg-slate-50 p-4">
                ...
                <p className="text-sm leading-7 text-slate-600">
                  درخواست‌های مشتریان را پیگیری و وضعیت آن‌ها را بروزرسانی کنید.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-[32px] border border-purple-100 bg-purple-50 p-6 text-purple-950">
            ...
            <p className="mt-4 text-sm leading-8">
              هر پاسخ تاییدشده‌ای که به بانک دانش اضافه می‌شود، کیفیت پاسخ‌های
              بعدی آرتین را بهتر می‌کند. بهتر است پاسخ‌های پرتکرار، سوالات مهم
              مشتریان و نکات تخصصی تجهیزات یا مواد، به‌صورت منظم وارد بانک دانش
              شوند.
            </p>
