...
- [ ] 1.2 نمایش متادیتای کیفیت پاسخ در پنل ادمین سوالات
- [ ] 1.3 ساخت مجموعه سوالات ارزیابی AI با نمونه‌های فارسی/انگلیسی و صنعتی
- [ ] 1.4 افزودن اسکریپت اجرای eval آفلاین/نیمه‌آفلاین برای سنجش کیفیت پاسخ‌ها
- [ ] 1.5 اضافه کردن گزارش خلاصه eval در docs یا admin

## فاز 2: بهبود RAG و بانک دانش

هدف: پاسخ‌ها دقیق‌تر، کم‌توهم‌تر، و قابل ردیابی‌تر شوند.

- [ ] 2.1 صفحه وضعیت فایل‌های دانش: تعداد chunk، دسته‌بندی، وضعیت embedding، آخرین sync
- [ ] 2.2 امکان re-index/re-embed انتخابی برای هر فایل دانش
- [ ] 2.3 بهبود hybrid search با ترکیب exact model/code، keyword، vector و score قابل توضیح
...
- [ ] 3.1 پایدارسازی streaming/reconnect و دکمه stop/regenerate
- [ ] 3.2 جستجو در history چت‌های مشتری
- [ ] 3.3 بهبود کارت‌های محصول/دستگاه مرتبط
...
- [ ] 4.2 rate limit برای admin login سمت Next.js
